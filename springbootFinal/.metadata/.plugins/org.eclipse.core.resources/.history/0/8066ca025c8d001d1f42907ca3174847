                                          ...
                                          <!-- 필터 검색 DIV 끝 -->  
                                           ...
                                           <table id="weatherTbl" style="width:100%;">
                                              ...
                                              <tr>
                                                 ...
                                                 <td class="dayTd" style="text-align: center;">목요일</td>
                                                 <td>최저</td>
                                                 <td>최고</td>
                                              </tr>
                                              <tr>
                                                 <td class="weatherTd" ><img class="weatherIcon" alt="눈" src="images/weather/snowy.gif"/></td>
                                                 <td class="dayTd" style="text-align: center;">금요일</td>
                                                 <td>최저</td>
                                                 <td>최고</td>
                                              </tr>
                                              <tr>
                                                 <td class="weatherTd" ><img class="weatherIcon" alt="태풍" src="images/weather/typhoon.gif"/></td>
                                                 <td class="dayTd" style="text-align: center;">토요일</td>
                                                 <td>최저</td>
                                                 <td>최고</td>
                                              </tr>
