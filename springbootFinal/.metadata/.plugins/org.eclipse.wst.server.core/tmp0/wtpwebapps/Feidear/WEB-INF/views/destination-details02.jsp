                ...
                <ul class="navbar-nav">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <!-- 한솔 수정 -->
                            ...
                            <li><a href="blog-details02">축제일기 상세</a></li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form class="tp-form-wrap bg-gray tp-form-wrap-one">
                            <div class="row">
                                <div class="col-md-6"><h4 class="single-page-small-title">축제 일기 작성하기</h4></div>
                                <div class="col-md-6">
                                    <div class="tp-review-meta text-lg-right">
                                        <span class="ml-0">추 천 별 점</span>
                                ...
                                <div class="col-md-6">
                                    <label class="single-input-wrap">
                                        <span class="single-input-title">일기 제목</span>
                                        <input type="text">
                                    </label>
                                </div>
                                <div class="col-lg-12">
                                    <label class="single-input-wrap">
                                        <span class="single-input-title">일기 내용</span>
                                        <textarea></textarea>
                                    </label>
                                </div>
                                <div class="col-12">
                                    <a class="btn btn-blue" href="#">+ 사진 추가 <img src="<%=pjName%>/resources/assets/images/photos_28.png"></a>
                                    <button class="btn btn-yellow float-right" href="#">저 장</button>
                                </div>
                            </div>
                        </form>
                    </div>
