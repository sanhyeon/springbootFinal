                        ...
                        <img src="images/others/11.png" alt="img">
                			...
                			<div class="col-xl-3 col-lg-4">
                        	    <div class="wrapper">
							        ...
							        <div class="area">
							            <select id="area">
							                <option selected disabled>내 지역 선택</option>
									...
									<div class="gender">
										<input id="gender_man" type="radio" name="gender">&nbsp&nbsp남성  
										&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input id="gender_woman" type="radio" name="gender">&nbsp&nbsp여성
							        ...
							        <div class="u_group"> 
							            <input id="normal_user" type="radio" name="user">&nbsp&nbsp일반 회원 
							            &nbsp&nbsp&nbsp&nbsp&nbsp<input id="fstv_user" type="radio" name="user">&nbsp&nbsp축제 관계자
							        </div><br>
							        ...
							        <div class="input-group-append">
							        	<div class="signUp">
                                			<button id="signUpButton" class="btn btn-yellow" type="button" disabled onclick="signUpCheck()">가입하기</button>
                                		</div>
                            		</div>
							    </div>
                        </div>
