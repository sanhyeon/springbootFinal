                ...
                <div class="container">
                        ...
                        <div class="tp-gallery-item col-lg-6 col-md-7 col-sm-10">
                            <div class="tp-gallery-item-img">
                                <a href="#" data-effect="mfp-zoom-in">
                                    <img src="images/tour-details/720x422.png" alt="image">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-4">
                            <div class="details">
                                <p class="location mb-0"><i class="fa fa-map-marker"></i>강원도 평창군</p>
                                <h4 class="title">대관령 눈꽃 축제</h4><br>
                                <div class="all-tags">
                                    <a href="#">Adventures</a>
                        ...
                        <div class="col-xl-9 col-lg-8">
                            <div class="book-list-warp">
                                <p class="book-list-content">강릉시와 평창군을 가르는 험준한 산맥, 대관령. 해발고도 832m의 이 고고한 산맥은 수많은 전설로 인해 더욱 아름답게만 보이는 곳.<br>
                                김유신 장군이 무술을 연마했던 곳도, 고려의 태조 왕건을 돕기 위한 군대가 지났던 곳도 바로 대관령이다.</p><br>
                            </div><br>
                            <ul class="tp-list-meta border-tp-solid">
                                <li class="ml-0"><i class="fa fa-calendar-o"></i> 1 JAN</li>
                                <li><i class="fa fa-clock-o"></i> 9 Days</li>
                                <li><i class="fa fa-snowflake-o"></i> Winter</li>
                            </ul>
                        </div>   
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="tour-details-wrap">
                        <h4 class="single-page-small-title">상세정보</h4>
                        ...
                        <div class="package-included-location">
                            <h4 class="single-page-small-title">추천 코스</h4>
                            <div class="row">
                        ...
                        <div class="host-area">
                            <div class="single-host-wrap text-center">
                                ...
                                <a class="btn btn-yellow" href="#">리뷰 보러가기</a>
                            </div>
                        </div>
