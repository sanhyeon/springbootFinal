...
<%String pjName = "/Feidear";%>
			...
			<!-- NProgress -->
			<link
				href="admin/vendors/nprogress/nprogress.css"
				rel="stylesheet">
			
			<!-- iCheck -->
			<link
				href="admin/vendors/iCheck/skins/flat/green.css"
				rel="stylesheet">
			...
			<!-- JQVMap -->
			<link
				href="admin/vendors/jqvmap/dist/jqvmap.min.css"
				rel="stylesheet" />
			
			<!-- Switchery -->
			<link
				href="admin/vendors/switchery/dist/switchery.min.css"
				rel="stylesheet">
			
			<!-- Dropzone.js -->
			<link
				href="admin/vendors/dropzone/dist/min/dropzone.min.css"
				rel="stylesheet">
			<!-- 일단 이상 없는 것들 끝 -->
			<!-- Custom Theme Style 
			...
			<div class="signUp-popup login-register-popup" id="signUp-popup">
				<div class="login-register-popup-wrap">
					<div class="row no-gutters">
						<div class="col-lg-6">
							<div class="thumb">
								<img src="images/others/signup.png"
									alt="img">
							</div>
						</div>
						<div class="col-lg-6 align-self-center">
							<div class="shape-thumb">
								<img
									src="images/others/signup-shape.png"
									alt="img">
							</div>
							<form class="login-form-wrap">
								...
								<div class="single-input-wrap style-two">
									<input type="text" placeholder="Name"> <span
										class="single-input-title"><i class="fa fa-user"></i></span>
								</div>
								<div class="single-input-wrap style-two">
									<input type="text" placeholder="Email"> <span
										class="single-input-title"><i class="fa fa-envelope"></i></span>
								</div>
								<div class="single-input-wrap style-two">
									<input type="text" placeholder="Password"> <span
										class="single-input-title"><i class="fa fa-lock"></i></span>
								</div>
			...
			<div class="breadcrumb-area style-three jarallax"
					...
					<div class="row justify-content-center">
						<div class="col-xl-10">
							<div class="destinations-details-main-slider-wrap">
								<div class="destinations-details-main-slider"></div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12 col-sm-12 ">
						...
						<!-- (축제 일기) 리뷰 등록 페이지 시작 -->
							<div class="tab-pane active" id="contact" role="tabpanel"
								...
								<h2
									style="margin: 20px auto; font-size: 32px; font-weight: bolder;">축제 일기
									등록</h2>
								...
								<div class="x_content">
									...
									<div id="editor-one" class="editor-wrapper" style="height: 500px;"></div>

									<textarea name="rv_content" id="descr" style="display: none;"></textarea>
