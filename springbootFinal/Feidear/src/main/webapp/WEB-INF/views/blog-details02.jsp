        ...
        <div class="container nav-container">
            ...
            <div class="collapse navbar-collapse" id="tp_main_menu">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                        <!-- 한솔 수정 -->
                            <li><a href="review-list">축제일기</a></li>			
                            <li><a href="reviews-details">축제일기 상세</a></li>
                            <li><a href="magazine">매거진</a></li>
                            <li><a href="blog-details03">매거진 상세</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children">
                        <a href="#">이벤트</a>
            ...
            <div class="nav-right-content">
                <ul>
                    ...
                    <li class="pr-0">
                        <a class="btn btn-yellow" href="tour-details">축제 캘린더<i class="fa fa-paper-calender"></i></a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget widget_search bg-none pd-none">
                        	<form class="write-form">
                                <div class="form-group">
                                  <button class="submit-btn" type="submit"><a href="reviews-write">나의 일기 쓰러 가기 <img src="images/pencil_24.png" ></button>
                                </div>
                            </form></br>
                        </div>
