                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <ul class="nav nav-tabs tp-tabs style-two">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active show" data-toggle="tab" href="#tabs_3"><i class="fa fa-bar-chart" aria-hidden="true"></i>디어유 모집</a>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <div class="row">
                                        	<div class="col-lg-12 bg-gray" style="padding-top: 3vw;">
                                                ...
                                                <div class="col-lg-5" style="margin: 0px auto;">
                                                	<h4 style="text-align: center; margin-bottom: 30px;">디어유가 되어 줘!</h4>
                                            	...
                                            	<div class="col-lg-10 widget-contact" style="margin: 0px auto;">
		                            				...
		                            				<p>
		                            					...
		                            					<a class="btn btn-transparent" href="#" style="margin: 1vw;">신청서 다운로드</a>
		                            					<!-- 신청서 양식 다운로드 버튼 시작 -->
