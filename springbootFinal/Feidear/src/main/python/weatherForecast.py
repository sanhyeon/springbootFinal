...
def GetWeatherAfter3Days(idx):
    ...
    for c in cities:
        ...
        for day in range(3, 8):
            ...
            # print(day, '일 후 오전 강수 확률 :', res[rnAM])
            # print(day, '일 후 오후 강수 확률 :', res[rnPM])
            # print(day, '일 후 오전 일기예보 :', res[wfAM])
            # print(day, '일 후 오후 일기예보 :', res[wfPM])
...
if __name__ == "__main__":
    GetWeatherAfter3Days()# type: ignore